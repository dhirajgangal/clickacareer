            ...
            <section class="w-f scrollable">
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav">
                    <li  class="active">
                      <a href="<?php echo BASE_URL?>adminclickacareer/user"   class="active">
                   ...
                   <li >
                      <a href="<?php echo BASE_URL?>adminclickacareer/company"  >
...
<!--                      <ul class="nav lt">
                    ...
                    <li >
                      <a href="<?php echo BASE_URL?>adminclickacareer/job"  >
